/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2c2c56095c3bcc06c00adf14dfdb123a)
// Runtime types generated with workerd@1.20250525.0 2024-11-27 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CACHE_KV: KVNamespace;
		PAGE_TITLE: "Apollo's Gallery";
		DESCRIPTION: "Cute Shiba Inu pictures daily! Check out his amazing adventures and sign up for updates!";
		COPYRIGHT: "SocksTheWolf";
		KOFI_USERNAME: "SocksTheWolf";
		COLOR_SCHEME: "orange";
		GALLERY_PATH: "/";
		IMGT: string;
		USERNAME: string;
